-- =============================================================================
-- TumApply Test Data — Combined Seed Script
--
-- Generated for one-shot execution on deployed environments where
-- import-testdata.sh is not available. This file is the alphabetical
-- concatenation of every individual *.sql seed file in this directory,
-- excluding 00_drop_all_tables.sql (the destructive reset).
--
-- Source files (run in this order):
--   01_users.sql, 02a_schools.sql, 02b_departments.sql, 02c_research_groups.sql,
--   03_user_roles.sql, 04_jobs.sql, 06_applicants.sql, 07_applications.sql,
--   08_application_reviews.sql, 08a_documents.sql, 09_internal_comments.sql,
--   10_interview_processes.sql, 11_interview_slots.sql, 12_interview_scenario.sql,
--   13_deleted_user.sql
--
-- DO NOT EDIT THIS FILE BY HAND. Update the individual *.sql files in this
-- directory and regenerate this combined script.
-- =============================================================================
...
-- END 02b_departments.sql


-- =============================================================================
-- BEGIN 02c_research_groups.sql
-- =============================================================================
-- =============================================
...
-- END 02c_research_groups.sql


-- =============================================================================
-- BEGIN 03_user_roles.sql
-- =============================================================================
-- =============================================
-- 03_user_roles.sql
...
-- END 06_applicants.sql


-- =============================================================================
-- BEGIN 07_applications.sql
-- =============================================================================
-- =============================================
-- 07_applications.sql
...
-- END 07_applications.sql


-- =============================================================================
-- BEGIN 08_application_reviews.sql
-- =============================================================================
-- =============================================
...
-- END 08_application_reviews.sql


-- =============================================================================
-- BEGIN 08a_documents.sql
-- =============================================================================
-- =============================================
-- 08a_documents.sql
...
-- END 08a_documents.sql


-- =============================================================================
-- BEGIN 09_internal_comments.sql
-- =============================================================================
-- =============================================
...
-- END 09_internal_comments.sql


-- =============================================================================
-- BEGIN 10_interview_processes.sql
-- =============================================================================
-- ===========================================================
...
-- END 10_interview_processes.sql


-- =============================================================================
-- BEGIN 11_interview_slots.sql
-- =============================================================================
-- ===========================================================
...
-- END 11_interview_slots.sql


-- =============================================================================
-- BEGIN 12_interview_scenario.sql
-- =============================================================================
-- ===========================================================
...
-- END 12_interview_scenario.sql


-- =============================================================================
-- BEGIN 13_deleted_user.sql
-- =============================================================================
-- =============================================
-- 13_deleted_user.sql
