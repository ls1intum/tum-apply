...
export const APIS = [ActuatorService, ApplicationEvaluationResourceService, ApplicationResourceService, AuthenticationResourceService, DocumentResourceService, EmailSettingResourceService, EmailTemplateResourceService, InternalCommentResourceService, JobResourceService, RatingResourceService, UserResourceService];
