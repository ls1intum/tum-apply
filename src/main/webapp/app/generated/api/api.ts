...
export * from './researchGroupRessource.service';
import { ResearchGroupRessourceService } from './researchGroupRessource.service';
export * from './userResource.service';
import { UserResourceService } from './userResource.service';
export const APIS = [ActuatorService, ApplicationEvaluationResourceService, ApplicationResourceService, AuthenticationResourceService, DocumentResourceService, EmailSettingResourceService, EmailTemplateResourceService, InternalCommentResourceService, JobResourceService, RatingResourceService, ResearchGroupRessourceService, UserResourceService];
