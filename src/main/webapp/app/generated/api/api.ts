...
export const APIS = [ApplicationEvaluationResourceService, ApplicationResourceService, DocumentResourceService, EmailLoginResourceService, EmailSettingResourceService, EmailTemplateResourceService, JobResourceService, UserResourceService];
