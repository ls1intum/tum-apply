...
import { JobCardDTO } from '../model/jobCardDTO'; // @ts-ignore
import { JobDetailDTO } from '../model/jobDetailDTO'; // @ts-ignore
import { JobFormDTO } from '../model/jobFormDTO'; // @ts-ignore
...
export class JobResourceService extends BaseService {
  ...
  public getJobsByProfessor(
    ...
    let localVarPath = `/api/jobs/professor/${this.configuration.encodeParam({
      name: 'userId',
      value: userId,
      in: 'path',
      style: 'simple',
  ...
  public updateJob(
    ...
    let localVarPath = `/api/jobs/jobform/${this.configuration.encodeParam({
      name: 'jobId',
      value: jobId,
      in: 'path',
      style: 'simple',
