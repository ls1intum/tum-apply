...
export class ApplicationResourceApiService extends BaseService {
    ...
    public getApplicantProfileDocumentIds(): Observable<ApplicationDocumentIdsDTO> {
        return this.httpClient.get<ApplicationDocumentIdsDTO>(`${this.configuration.basePath}/api/applications/profile/document-ids`, {
            withCredentials: this.configuration.withCredentials,
            headers: this.defaultHeaders.set('Accept', 'application/json'),
        });
    }

    public updateApplicantPersonalInformation(applicantDTO: ApplicantDTO): Observable<ApplicantDTO> {
        if (applicantDTO === null || applicantDTO === undefined) {
            throw new Error('Required parameter applicantDTO was null or undefined when calling updateApplicantPersonalInformation.');
        }

        return this.httpClient.put<ApplicantDTO>(`${this.configuration.basePath}/api/applications/profile/personal-information`, applicantDTO, {
            withCredentials: this.configuration.withCredentials,
            headers: this.defaultHeaders.set('Accept', 'application/json'),
        });
    }

    public updateApplicantDocumentSettings(applicantDTO: ApplicantDTO): Observable<ApplicantDTO> {
        if (applicantDTO === null || applicantDTO === undefined) {
            throw new Error('Required parameter applicantDTO was null or undefined when calling updateApplicantDocumentSettings.');
        }

        return this.httpClient.put<ApplicantDTO>(`${this.configuration.basePath}/api/applications/profile/document-settings`, applicantDTO, {
            withCredentials: this.configuration.withCredentials,
            headers: this.defaultHeaders.set('Accept', 'application/json'),
        });
    }

    public uploadApplicantProfileDocuments(documentType: 'BACHELOR_TRANSCRIPT' | 'MASTER_TRANSCRIPT' | 'REFERENCE' | 'CV' | 'CUSTOM', files?: Blob): Observable<Array<DocumentInformationHolderDTO>> {
        if (documentType === null || documentType === undefined) {
            throw new Error('Required parameter documentType was null or undefined when calling uploadApplicantProfileDocuments.');
        }

        let localVarHeaders = this.defaultHeaders.set('Accept', 'application/json');
        const localVarFormParams = new FormData();

        if (files !== undefined) {
            localVarFormParams.append('files', <any>files);
        }

        return this.httpClient.post<Array<DocumentInformationHolderDTO>>(
            `${this.configuration.basePath}/api/applications/profile/upload-documents/${this.configuration.encodeParam({name: "documentType", value: documentType, in: "path", style: "simple", explode: false, dataType: "'BACHELOR_TRANSCRIPT' | 'MASTER_TRANSCRIPT' | 'REFERENCE' | 'CV' | 'CUSTOM'", dataFormat: undefined})}`,
            localVarFormParams,
            {
                withCredentials: this.configuration.withCredentials,
                headers: localVarHeaders,
    ...
    public deleteApplicantProfileDocument(documentDictionaryId: string): Observable<void> {
        if (documentDictionaryId === null || documentDictionaryId === undefined) {
        ...
        return this.httpClient.delete<void>(`${this.configuration.basePath}/api/applications/profile/delete-document/${this.configuration.encodeParam({name: "documentDictionaryId", value: documentDictionaryId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: "uuid"})}`, {
            withCredentials: this.configuration.withCredentials,
        });
    }

    public renameApplicantProfileDocument(documentDictionaryId: string, newName: string): Observable<void> {
        if (documentDictionaryId === null || documentDictionaryId === undefined) {
        ...
        const params = new HttpParams({ encoder: this.encoder }).set('newName', newName);
        return this.httpClient.put<void>(
            `${this.configuration.basePath}/api/applications/profile/rename-document/${this.configuration.encodeParam({name: "documentDictionaryId", value: documentDictionaryId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: "uuid"})}`,
            null,
            {
                params,
                withCredentials: this.configuration.withCredentials,
