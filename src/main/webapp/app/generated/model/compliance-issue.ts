...
export type ComplianceIssueCategoryEnum = 'CRITICAL_AGG' | 'TRANSPARENCY' | 'DSGVO_MINIMIZATION' | 'PUBLIC_SECTOR';
...
export const ComplianceIssueCategoryEnumValues = ['CRITICAL_AGG', 'TRANSPARENCY', 'DSGVO_MINIMIZATION', 'PUBLIC_SECTOR'] as const;
