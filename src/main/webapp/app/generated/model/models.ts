...
export * from './dependenciesOverviewDTO';
...
export * from './pageResponseDTOSchoolDTO';
...
export * from './userDTO';
export * from './userDataExportException';
export * from './userDataExportExceptionCause';
export * from './userDataExportExceptionCauseStackTraceInner';
export * from './userDataExportExceptionCauseSuppressedInner';
