...
export namespace EmailTemplateDTO {
    ...
    export const EmailTypeEnum = {
        ...
        InterviewLocationChanged: 'INTERVIEW_LOCATION_CHANGED' as EmailTypeEnum,
        InterviewSelfSchedulingInvitation: 'INTERVIEW_SELF_SCHEDULING_INVITATION' as EmailTypeEnum,
        InterviewCancelled: 'INTERVIEW_CANCELLED' as EmailTypeEnum,
        InterviewRescheduleRequested: 'INTERVIEW_RESCHEDULE_REQUESTED' as EmailTypeEnum,
        DataExportReady: 'DATA_EXPORT_READY' as EmailTypeEnum,
        UserDataDeletionWarning: 'USER_DATA_DELETION_WARNING' as EmailTypeEnum,
        ApplicantDataDeletionWarning: 'APPLICANT_DATA_DELETION_WARNING' as EmailTypeEnum
    };
}
