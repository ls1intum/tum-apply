 ...
 * Each email type defines the recipients (based on UserRole).
 */
@Getter
@AllArgsConstructor
public enum EmailType {
     ...
     */
    APPLICATION_REJECTED_JOB_FILLED("APPLICATION_REJECTED_JOB_FILLED", Set.of(UserRole.APPLICANT)),

    /**
     * Rejection because the job listing is outdated.
     * To: Applicant whose application was rejected
     */
    APPLICATION_REJECTED_JOB_OUTDATED("APPLICATION_REJECTED_JOB_OUTDATED", Set.of(UserRole.APPLICANT)),

    /**
     * Rejection because the applicant did not meet the requirements.
     * To: Applicant whose application was rejected
     */
    APPLICATION_REJECTED_FAILED_REQUIREMENTS("APPLICATION_REJECTED_FAILED_REQUIREMENTS", Set.of(UserRole.APPLICANT)),

    /**
     * Rejection for any other reason.
     * To: Applicant whose application was rejected
     */
    APPLICATION_REJECTED_OTHER_REASON("APPLICATION_REJECTED_OTHER_REASON", Set.of(UserRole.APPLICANT)),

    /**
     * When a new application was received for a job
     * To: Supervising professor of the job
     */
    APPLICATION_RECEIVED("APPLICATION_RECEIVED", Set.of(UserRole.PROFESSOR, UserRole.EMPLOYEE)),
     ...
     */
    JOB_PUBLISHED_SUBJECT_AREA("JOB_PUBLISHED_SUBJECT_AREA", Set.of(UserRole.APPLICANT)),

    /**
     * Interview invitation when applicant is assigned to an interview slot
     * To: Applicant who was assigned to the slot
     */
    INTERVIEW_INVITATION("INTERVIEW_INVITATION", Set.of(UserRole.APPLICANT)),

    /**
     * When a user is added to a research group
     * To: Newly added member
     */
    RESEARCH_GROUP_MEMBER_ADDED("RESEARCH_GROUP_MEMBER_ADDED", Set.of(UserRole.EMPLOYEE, UserRole.PROFESSOR)),

    /**
     * When a research group request is approved
     * To: Research group owner (professor)
     */
    RESEARCH_GROUP_APPROVED("RESEARCH_GROUP_APPROVED", Set.of(UserRole.PROFESSOR)),

    /**
     * Confirmation when applicant books their own interview slot
     * To: Applicant who booked the slot
     */
    INTERVIEW_BOOKED_APPLICANT("INTERVIEW_BOOKED_APPLICANT", Set.of(UserRole.APPLICANT)),

    /**
     * Notification to professor when applicant books an interview slot
     * To: Supervising professor of the job
     */
    INTERVIEW_BOOKED_PROFESSOR("INTERVIEW_BOOKED_PROFESSOR", Set.of(UserRole.PROFESSOR, UserRole.EMPLOYEE)),

    /**
     * Confirmation to professor when they manually assign a slot to an applicant
     * To: Supervising professor of the job
     */
    INTERVIEW_ASSIGNED_PROFESSOR("INTERVIEW_ASSIGNED_PROFESSOR", Set.of(UserRole.PROFESSOR, UserRole.EMPLOYEE)),

    /**
     * Notification when the location of a booked interview slot is updated
     * To: Applicant whose booked slot location was changed
     */
    INTERVIEW_LOCATION_CHANGED("INTERVIEW_LOCATION_CHANGED", Set.of(UserRole.APPLICANT)),

    /**
     * Invitation to self-schedule an interview slot
     * To: Applicant
     */
    INTERVIEW_SELF_SCHEDULING_INVITATION("INTERVIEW_SELF_SCHEDULING_INVITATION", Set.of(UserRole.APPLICANT)),

    /**
     * Notification that an interview slot was cancelled (and no new link is sent)
     * To: Applicant
     */
    INTERVIEW_CANCELLED("INTERVIEW_CANCELLED", Set.of(UserRole.APPLICANT)),
     ...
     * To: Applicant
     */
    INTERVIEW_RESCHEDULE_REQUESTED("INTERVIEW_RESCHEDULE_REQUESTED", Set.of(UserRole.APPLICANT)),

    /**
     * Data export ready notification
     * To: User who requested the export
     */
    DATA_EXPORT_READY("DATA_EXPORT_READY", Set.of(UserRole.APPLICANT, UserRole.PROFESSOR, UserRole.EMPLOYEE, UserRole.ADMIN)),
     ...
     */
    USER_DATA_DELETION_WARNING("USER_DATA_DELETION_WARNING", Set.of(UserRole.APPLICANT, UserRole.EMPLOYEE, UserRole.PROFESSOR)),
     ...
     */
    APPLICANT_DATA_DELETION_WARNING("APPLICANT_DATA_DELETION_WARNING", Set.of(UserRole.APPLICANT));
