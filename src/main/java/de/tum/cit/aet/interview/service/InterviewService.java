...
public class InterviewService {
    ...
    public List<UpcomingInterviewDTO> getUpcomingInterviews() {
        ...
        Page<InterviewSlot> slots = interviewSlotRepository.findUpcomingBookedSlotsForProfessor(professorId,
                Instant.now(), limit);
    ...
    public PageResponseDTO<InterviewSlotDTO> getSlotsByProcessId(
        ...
        if (year != null && month != null) {
            ...
            slotsPage = interviewSlotRepository.findByProcessIdAndMonthWithDateFilter(
                    processId,
    ...
    public Optional<InterviewSlotDTO> getFirstFutureSlot(UUID processId) {
        ...
        // 3. Find first slot
        Page<InterviewSlot> page = interviewSlotRepository.findFutureSlots(processId, Instant.now(),
                PageRequest.of(0, 1));
        if (page.hasContent()) {
