...
public class InterviewService {
     ...
     * @throws ResponseStatusException if the process is not found, the user is not authorized,
     *                                 or any time conflicts are detected
     */
     ...
     * If a conflict is detected, a {@link ResponseStatusException} with
