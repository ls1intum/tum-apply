    ...
    private String generateRegistrationConfirmationHTML() {
        return """
          ...
          <div style="text-align:center;margin:24px 0;">
            <a href="https://tumapply.de" style="display:inline-block;padding:12px 24px;background:#0A66C2;color:#ffffff;text-decoration:none;border-radius:6px;font-weight:600;">Get Started</a>
          </div>
