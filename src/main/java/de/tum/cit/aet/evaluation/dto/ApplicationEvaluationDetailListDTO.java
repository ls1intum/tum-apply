...
public record ApplicationEvaluationDetailListDTO(
    ...
    public static ApplicationEvaluationDetailListDTO fromApplications(
        ...
        return fromApplications(applications, totalRecords, currentIndex, windowIndex, null, null);
    }
    ...
    public static ApplicationEvaluationDetailListDTO fromApplications(
        ...
        return fromApplications(applications, totalRecords, currentIndex, windowIndex, ratingCalculator, null);
    }
     ...
     * @param ratingCalculator      a function to calculate the average rating for each
     *                              application (optional)
     * @param ratingCountCalculator a function to calculate the number of ratings for
     *                              each application (optional)
     * @return a new {@link ApplicationEvaluationDetailListDTO} containing the
     *         converted details and metadata
     */
    public static ApplicationEvaluationDetailListDTO fromApplications(
        ...
        Integer windowIndex,
        Function<Application, Double> ratingCalculator,
        Function<Application, Integer> ratingCountCalculator
    ) {
            ...
            applications
                ...
                .map(app -> {
                    ...
                    if (ratingCalculator != null) {
                        dto = dto.withAverageRating(ratingCalculator.apply(app));
                    }
                    if (ratingCountCalculator != null) {
                        dto = dto.withRatingCount(ratingCountCalculator.apply(app));
                    }
                    return dto;
                })
                .toList(),
