...
class WebAuthnPasskeyResourceTest {
    ...
    @Test
    void listsCurrentUsersPasskeys() {
    ...
    @Test
    void listReturnsEmptyWhenUserHasNoWebAuthnEntity() {
    ...
    @Test
    void removeReturnsNotFoundForMalformedCredentialId() {
        when(userEntityRepository.findByUsername(jwt.getSubject())).thenReturn(userEntity());
    ...
    @Test
    void removeReturnsNotFoundForCredentialOwnedByAnotherUser() {
    ...
    @Test
    void removeDeletesOwnedCredential() {
