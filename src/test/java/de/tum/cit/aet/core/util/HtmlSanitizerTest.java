...
class HtmlSanitizerTest {
    ...
    @Nested
    class XssPayloadStrippingTests {
    ...
    @Nested
    class BasicFormattingPreservationTests {
    ...
    // ===== QUILL CLASS HANDLING =====
    @Nested
    class QuillClassHandlingTests {
    ...
    // ===== QUILL DATA-LIST ATTRIBUTE =====
    @Nested
    class QuillDataListAttributeTests {
    ...
    @Nested
    class ComplexMixedContentTests {
