...
describe('ProgressStepperComponent', () => {
    ...
    beforeEach(async () => {
        ...
        const stepperDebugElement = fixture.debugElement.query(
            (de) => de.componentInstance instanceof ProgressStepperComponent
        );
    ...
    it('should call button onClick and change panel when changePanel is true', () => {
        ...
        const buttonGroupData = component.buildButtonGroupData(
            hostComponent.steps[0].buttonGroupNext,
            'next',
            1
        );
    ...
    it('should call button onClick but not change panel when changePanel is false', () => {
        ...
        const buttonGroupData = component.buildButtonGroupData(
            hostComponent.steps[1].buttonGroupNext,
            'next',
            2
        );
    ...
    it('should navigate to previous step when prev button with changePanel is clicked', () => {
        ...
        const buttonGroupData = component.buildButtonGroupData(
            hostComponent.steps[1].buttonGroupPrev,
            'prev',
            2
        );
