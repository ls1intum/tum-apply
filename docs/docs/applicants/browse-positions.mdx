...
<VideoEmbed
  src="https://live.rbg.tum.de/w/artemisintro/74604?video_only=1&t=0"
  title="Browsing positions in TUMApply"
  caption="Browsing available positions and redirecting to notifications"
/>
...
<Image src={findPositionsImg} alt="Find Positions Page" size={ImageSize.large} caption="Find Positions Page"/>
...
## 🔔 Stay Informed About New Positions

While browsing positions, you can jump directly to your notification preferences from the **Find Positions** page.

- A shortcut link opens **Settings > Notifications**
- There you can enable emails for newly published jobs in selected subject areas
- This allows you to subscribe to future opportunities even if you are not ready to apply yet

For the full settings overview, see [Settings](settings).
...
<Image src={jobDetailImg2} alt="Job Detail Page View 2" size={ImageSize.large} caption="Job Detail Page"/>
...
5. Use the notification shortcut at the bottom of the page if you want subject-area email alerts for future postings
6. Click **"View"** on any position card to access detailed information
