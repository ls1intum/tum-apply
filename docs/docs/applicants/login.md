...
- **Email and Code:** Enter your email address. You will receive a verification code by email. Enter the code to log in.
  No password is required for this method. ([Video](https://live.rbg.tum.de/w/artemisintro/67994))

- **Email and Password:** If you have set a password during registration, you can log in with your email address and
  password. ([Video](https://live.rbg.tum.de/w/artemisintro/67996))

- **Google, Apple or Microsoft:** Click the respective button. You will be redirected to the selected provider to
  authenticate, and then returned to TUMApply, logged in
  automatically. ([Video](https://live.rbg.tum.de/w/artemisintro/61949))
