...
import page1Img from './images/applying/application-form-page1.png';
import page2Img from './images/applying/application-form-page2.png';
import page3Img_part1 from './images/applying/application-form-page3_1.png';
import page3Img_part2 from './images/applying/application-form-page3_2.png';
import page4Img_part1 from './images/applying/application-form-page4_1.png';
import page4Img_part2 from './images/applying/application-form-page4_2.png';

# How to Apply for a Doctoral Position: Step-by-Step Guide

## Getting Started

Welcome to the DocApply Doctoral Portal application system! This guide will walk you through the complete application process, from finding a position to submitting your materials.

<VideoEmbed
  src="https://live.rbg.tum.de/w/artemisintro/74607?video_only=1&t=0"
  title="Applying for a position in DocApply"
  caption="Complete application flow from creating an application to submission"
/>

## Step 1: Finding and Selecting a Position

1. **Navigate to Available Positions**
- Log into the DocApply Doctoral Portal using your credentials
...
- **Fill in basic details**: Name, email, contact information, address, nationality, gender, and date of birth
...
<Image src={page1Img} alt="Application Form Page 1" size={ImageSize.large}/>

### Page 2: Academic Background & Documents
- **University information**: Bachelor and Master degrees, their grades, and institutions attended
- **Upload academic documents**:
- Degree certificates/transcripts (PDF format)
- **Document validation**: The system checks file format and size

<Image src={page2Img} alt="Application Form Page 2" size={ImageSize.large}/>

### Page 3: Application Details & Additional Documents
- **Provide application details**: Desired start date, Motivation, Skills, and Experiences
- **Upload supporting documents**:
- CV/Resume (Required)
- Reference letters (Optional)
- **Progress indicator**: Shows completion status of each section
<Image src={page3Img_part1} alt="Application Form Page 3 - Part 1"
       size={ImageSize.large}/>
<Image src={page3Img_part2} alt="Application Form Page 3 - Part 2"
       size={ImageSize.large}/>
...
- **Privacy and Requirements**: Accept data privacy notice and confirm doctoral requirements
...
<Image src={page4Img_part1} alt="Application Form Page 4 - Part 1"
       size={ImageSize.large}/>
<Image src={page4Img_part2} alt="Application Form Page 4 - Part 2"
       size={ImageSize.large}/>
