...
import resource1Img from '../images/keycloak-impersonation/Resource 1.png';
import resource2Img from '../images/keycloak-impersonation/Resource 2.png';
import permission1Img from '../images/keycloak-impersonation/Permission 1.png';
import permission2Img from '../images/keycloak-impersonation/Permission 2.png';
import permission3Img from '../images/keycloak-impersonation/Permission 3.png';
import policyImg from '../images/keycloak-impersonation/Policy.png';
...
## Impersonation and Token Exchange Flow in DocApply

In DocApply, impersonation is used when the server receives a user's email and verified OTP but needs to obtain a valid
...
1. The user submits their email and OTP to the DocApply server.
...
3. After verification, the server calls the Keycloak `/protocol/openid-connect/token` endpoint using the
   `tumapply-admin-api` client credentials.
...
To manually enable impersonation in Keycloak for DocApply, follow these steps:

:::warning
The UI and texts can differ between versions. This is the approach for version 26.3.1.
:::
...
<Image src={resource1Img} alt="Resource 1" size={ImageSize.large}/>
<Image src={resource2Img} alt="Resource 2" size={ImageSize.large}/>

### Permissions

<Image src={permission1Img} alt="Permission 1" size={ImageSize.large}/>
<Image src={permission2Img} alt="Permission 2" size={ImageSize.large}/>
<Image src={permission3Img} alt="Permission 3" size={ImageSize.large}/>

### Policy

<Image src={policyImg} alt="Policy" size={ImageSize.large}/>
...
documentation: [Keycloak Release Notes](https://www.keycloak.org/docs/latest/release_notes/index.html#supported-standard-token-exchange).
:::
