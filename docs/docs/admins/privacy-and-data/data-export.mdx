...
DocApply allows users to request a GDPR-compliant export of their personal data. Exports are processed automatically and delivered via email.
...
|---|---|---|
| `AET_DATA_EXPORT_ROOT` | Filesystem path where export ZIP files are stored | `/tmp/doc-apply-exports` |
