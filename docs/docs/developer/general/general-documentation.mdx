...
:::tip
Favor **reusable atomic components**. Prefer composing existing atoms/molecules before introducing new ones. When you must add a component:
...
### 2.3 Authorization and Security
