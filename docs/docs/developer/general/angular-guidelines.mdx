...
- Create **1 folder per component** with 4 files: `.html`, `.scss`, `.ts`, `.spec.ts`
...
`::ng-deep` is deprecated and should not be used in new code. If you need to style child component internals, use global stylesheets (`prime-ng-overrides.scss`) or PrimeNG's `styleClass` approach instead.

---

## Related Documentation

- [Client Styling Guidelines](./client-styling-guidelines) — Tailwind, PrimeNG, and CSS patterns
- [Color Theming & Styling](../theming/color-theming) — Complete theming guide

- [Client Testing](../testing/client-testing) — Client testing patterns
