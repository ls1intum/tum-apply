...
| **Prefix** | **When to Use** |
|---|---|
| `chore/` | For routine tasks that don't add features or fix bugs. Examples: refactoring, dependency updates, cleanup work. |
| `feat/` | When adding a **new feature** or significant enhancement to the application. |
| `docs/` | For changes to **documentation only**, such as README updates or MDX guides. |
| `test/` | When adding or updating **tests** (unit, integration, e2e). |
