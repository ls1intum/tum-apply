---
sidebar_label: Client Best Practices
---
...
- [General Documentation](./general-documentation) — Cross-cutting conventions
- [Testing Guide](../testing/testing-guide) — Testing patterns
