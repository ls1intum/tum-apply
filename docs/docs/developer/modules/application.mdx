...
import applicationOverviewImg from '../images/application/application-overview.png';
import applicationDetail1Img from '../images/application/application-detail-1.png';
import applicationDetail2Img from '../images/application/application-detail-2.png';
import applicationForm1Img from '../images/application/application-form-1.png';
import applicationForm2Img from '../images/application/application-form-2.png';
import applicationForm31Img from '../images/application/application-form-3-1.png';
import applicationForm32Img from '../images/application/application-form-3-2.png';
import applicationForm41Img from '../images/application/application-form-4-1.png';
import applicationForm42Img from '../images/application/application-form-4-2.png';
...
- `ApplicationCreationFormComponent`
  - Multi-step wizard (4 stages): Personal Info → Education (+ Document upload) → Application (+ Document upload) → Summary (+ Consent)
    ...
    <Image src={applicationForm1Img} alt="Step 1" size={ImageSize.large}/>
    <Image src={applicationForm2Img} alt="Step 2" size={ImageSize.large}/>
    <Image src={applicationForm31Img} alt="Step 3" size={ImageSize.large}/>
    <Image src={applicationForm32Img} alt="Step 3 continued" size={ImageSize.large}/>
    <Image src={applicationForm41Img} alt="Step 4" size={ImageSize.large}/>
    <Image src={applicationForm42Img} alt="Step 4 continued" size={ImageSize.large}/>
...
- `ApplicationDetailForApplicantComponent`
  ...
  <Image src={applicationDetail1Img} alt="Application Detail Page" size={ImageSize.large}/>
  <Image src={applicationDetail2Img} alt="Application Detail Page continued" size={ImageSize.large}/>
