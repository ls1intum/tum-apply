...
DocApply uses **Helios** to deploy PR branches to the testserver at `tumapply-test.aet.cit.tum.de`. Deployments are triggered manually after the Docker image has been built by the CI workflow.
