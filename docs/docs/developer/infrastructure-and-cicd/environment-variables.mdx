...
1. Define the variable or secret in **GitHub Repository Settings** → **Environments** for the relevant environment(s)
2. Ensure the variable is referenced in the deploy/build workflow if needed
3. Contact an admin if you need access to modify environment settings
