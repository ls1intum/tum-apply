...
6. After approval, contact [Aniruddh](https://github.com/az108) for the final merge

---

### Adding to the DocApply Project

Both the **Issue** and the **PR** should be added to the **DocApply** GitHub Project. You can do this from the right-hand sidebar of the issue or PR page.
...
Use the following table to determine the **Priority** field when adding your PR to the DocApply project:
...
Use the following table to determine the **Size** field when adding your PR to the DocApply project:
...
- [ ] Add both the issue and PR to the **DocApply** project
