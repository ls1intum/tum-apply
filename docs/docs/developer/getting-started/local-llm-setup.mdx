---
sidebar_label: Local LLM Setup
---

# Local LLM Setup

DocApply uses Spring AI for AI-powered features like job description generation and translation. To run these locally, you need a local LLM instance.
...
- **Model Size**: Larger models provide better results but require more RAM and processing power. The `gpt-oss-20b`
  model is a good balance for development. Use `google/gemma-3-1b` if your machine cannot handle it.
