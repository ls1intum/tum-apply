...
DocApply uses a **layered authorization strategy**, combining annotations and runtime access checks.
...
Supports: `Job`, `Application`, `ApplicationReview`, `InternalComment`, `ResearchGroup`
