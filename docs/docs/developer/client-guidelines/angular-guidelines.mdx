...
- Create **1 folder per component** with the component files: `.html`, `.ts`, and `.scss` only if needed (prefer Tailwind utility classes over custom SCSS — see [Client Styling](./client-styling-guidelines))
...
- [Client Styling](./client-styling-guidelines) — Tailwind, PrimeNG, and CSS patterns
