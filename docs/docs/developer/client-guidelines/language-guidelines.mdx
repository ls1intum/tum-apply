...
| **Regel** | **Beispiel** |
|---|---|
| Nutze neutrale Formulierungen | „Bewerber:innen" statt „Bewerber/Bewerberinnen" |
...
| **Vorher** | **Jetzt** |
|---|---|
| Bewerber / Bewerberin | Bewerber:in / Bewerber:innen |
| Dozent / Professor | Lehrende / Lehrkraft |
