...
For PrimeNG component overrides using `styleClass` vs `prime-ng-overrides.scss`, see the [Client Styling](./client-styling-guidelines#styling-primeng-components) page.
...
- See [Client Styling](./client-styling-guidelines) for styling best practices
- See [Client Development](./angular-guidelines) for Angular and TypeScript patterns
