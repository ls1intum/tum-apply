...
Styling patterns and best practices for the DocApply Angular client using Tailwind CSS, PrimeNG, and SCSS.
...
See [Color Theming](./color-theming) for complete reference.
...
- [Client Development](./client-development) — Component patterns, signals, and TypeScript best practices
