...
**CI coverage thresholds:** 50% statements, 40% branches, 50% functions, 50% lines.
...
| `pnpm run test:ci` | Run tests with CI coverage thresholds |
...
- Ensure at least **50% line coverage**
- Run `pnpm run test` to generate coverage reports
