...
DocApply uses [Liquibase](https://www.liquibase.org/) to manage database schema changes. All changelog files are located in `src/main/resources/config/liquibase/changelog/` and registered in `master.xml`.
