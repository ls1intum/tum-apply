...
This document describes the unified error handling approach in DocApply, including how exceptions are structured,
...
All handled exceptions in DocApply return a structured JSON object like this:
