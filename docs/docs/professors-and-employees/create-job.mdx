...
<Image src={creationStep1} alt="Job Creation Form Step 1" size={ImageSize.large} caption="Job Creation Form Step 1: Basic Information"/>
...
- **DocApply AI Assistant**: Toggle "Enable AI" to open the AI panel. Easily generate or rewrite the job description based on inputs or rough bullet points.
- **Multilingual Support**: Write the description in either German or English; the system translates it automatically.
- **Recommendation Letters**: Optionally require letters of recommendation for the position. Set **Required Recommendations** (0–5; 0 disables the feature) and choose what recommenders provide — a **letter**, a **structured evaluation**, or **both**. Applicants nominate their recommenders, who submit directly through a secure link. You read the submissions while [reviewing applications](./application-review), and applicants may choose to keep them confidential.
- **Validation System**: Users can only proceed using the **"Next"** button after completing required fields.

### Step 2: Employment Terms

<Image src={creationStep2} alt="Job Creation Form Step 2" size={ImageSize.large} caption="Job Creation Form Step 2: Employment Terms"/>
...
<Image src={creationStep3} alt="Job Creation Form Step 3" size={ImageSize.large} caption="Job Creation Form Step 3: Banner Image Selection"/>
...
<Image src={creationStep4_2} alt="Job Creation Form Step 4 Section 2" size={ImageSize.large} caption="Job Creation Form Step 4: Review"/>
...
- Provide the job description manually or use the **DocApply AI Assistant** to automatically draft or rewrite the description.
- If the position should require recommendation letters, set the number of **Required Recommendations** and choose what recommenders must provide (letter, evaluation, or both).
