...
<Image src={myPositionsImg} alt="My Positions Dashboard" size={ImageSize.large}/>
...
<Image src={jobProfessor2} alt="Job Details Page Professor 2" size={ImageSize.large}/>
<div style={{textAlign: 'center'}}>
...
**Video**:
<iframe
  src="https://live.rbg.tum.de/w/artemisintro/61938?video_only=1&t=0"
  title="Closing or Deleting Positions"
  allowFullScreen="1"
  frameBorder="0"
  width="600"
  height="350">
