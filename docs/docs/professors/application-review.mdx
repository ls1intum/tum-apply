...
* **Decision dialogs**: Accept, reject, or invite applicants to an interview through a guided dialog that confirms your choice and prepares communication.
* **Email notifications**: Send multilingual acceptance, rejection, or interview invitation messages with customizable templates.
...
* ⚪ **Interview**: The applicant has been invited to an interview.
...
Use the action buttons (*Accept*, *Reject*, or *Interview*) under the carousel. A confirmation dialog will appear.

* If you **accept**, you can optionally close the position and notify the applicant.
* If you **reject**, select a reason and confirm.
* If you **invite to interview**, the applicant will be added to the interview process for this position.
